...
const buildNormalizedParams_1 = require("./buildNormalizedParams");
...
function request(options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const queryString = options.queryParams && Object.keys(options.queryParams).length > 0
            ? `?${new URLSearchParams((0, buildNormalizedParams_1.buildNormalizedParams)(options.queryParams)).toString()}`
            : '';
        ...
        try {
            ...
            if (error instanceof makeCancelablePromise_1.CanceledPromiseError ||
