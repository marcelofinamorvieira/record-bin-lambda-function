...
function uploadLocalFileAndReturnPath(client, localPath, options = {}) {
    const filename = options.filename || (0, node_path_1.basename)(localPath);
    ...
    return (0, rest_client_utils_1.makeCancelablePromise)(() => __awaiter(this, void 0, void 0, function* () {
        ...
        uploadPromise = (0, uploadLocalFileToS3_1.uploadLocalFileToS3)(localPath, url, Object.assign(Object.assign({}, options), { additionalHeaders: request_headers, fetchFn: client.config.fetchFn }));
        yield uploadPromise;
        return id;
    }), () => {
        if (uploadPromise) {
