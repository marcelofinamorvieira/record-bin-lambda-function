...
const uploadLocalFileAndReturnPath_1 = require("../utils/uploadLocalFileAndReturnPath");
class Upload extends cma_client_1.Resources.Upload {
    /**
    ...
    createFromLocalFile(body) {
        ...
        return (0, rest_client_utils_1.makeCancelablePromise)(() => __awaiter(this, void 0, void 0, function* () {
            ...
            if (skipCreationIfAlreadyExists) {
                const checksum = yield (0, md5_1.default)(localPath);
                if (isCanceledBeforeUpload) {
                    throw new rest_client_utils_1.CanceledPromiseError();
                }
            ...
            runningPromise = (0, uploadLocalFileAndReturnPath_1.uploadLocalFileAndReturnPath)(this.client, localPath, {
                filename,
                onProgress,
            });
    ...
    createFromUrl(body) {
        ...
        return (0, rest_client_utils_1.makeCancelablePromise)(() => __awaiter(this, void 0, void 0, function* () {
            ...
            downloadPromise = (0, downloadFile_1.downloadFile)(url, {
                onProgress,
     ...
     */
    updateFromLocalFile(uploadId, body) {
        let isCanceledBeforeUpload = false;
        let runningPromise;
        return (0, rest_client_utils_1.makeCancelablePromise)(() => __awaiter(this, void 0, void 0, function* () {
            if (isCanceledBeforeUpload) {
            ...
            const { localPath, filename, onProgress } = body, other = __rest(body, ["localPath", "filename", "onProgress"]);
            runningPromise = (0, uploadLocalFileAndReturnPath_1.uploadLocalFileAndReturnPath)(this.client, localPath, {
                filename,
                onProgress,
            });
            ...
            return yield this.update(uploadId, Object.assign(Object.assign({}, other), { path }));
        }), () => {
            if (runningPromise) {
                runningPromise.cancel();
            }
    ...
    updateFromUrl(uploadId, body) {
        ...
        return (0, rest_client_utils_1.makeCancelablePromise)(() => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                runningPromise = this.updateFromLocalFile(uploadId, Object.assign({ localPath: filePath, onProgress }, other));
                const result = yield runningPromise;
                if (isCanceled) {
                    throw new rest_client_utils_1.CanceledPromiseError();
                }
