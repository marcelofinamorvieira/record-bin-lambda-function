...
function nonRecursiveMapBlocksInNonLocalizedFieldValueAsync(fieldType, nonLocalizedFieldValue, mapper) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (fieldType === 'structured_text') {
            ...
            return {
                schema: 'dast',
                document: yield (0, datocms_structured_text_utils_1.mapNodesAsync)(structuredTextValue.document, (node, _parent, path) => __awaiter(this, void 0, void 0, function* () {
                    if (node.type === 'block' || node.type === 'inlineBlock') {
...
function nonRecursiveFilterBlocksInNonLocalizedFieldValueAsync(fieldType, nonLocalizedFieldValue, predicate) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (fieldType === 'structured_text') {
            ...
            const filteredDocument = yield (0, datocms_structured_text_utils_1.filterNodesAsync)(structuredTextValue.document, (node, _parent, path) => __awaiter(this, void 0, void 0, function* () {
                if (node.type === 'block' || node.type === 'inlineBlock') {
