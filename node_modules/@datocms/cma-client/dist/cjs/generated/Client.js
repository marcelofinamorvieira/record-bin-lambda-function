...
var Client = /** @class */ (function () {
    ...
    Client.prototype.request = function (options) {
        var _this = this;
        return (0, rest_client_utils_1.request)(__assign(__assign(__assign({}, this.config), options), { logFn: this.config.logFn || console.log, userAgent: "@datocms/cma-client", baseUrl: this.baseUrl, preCallStack: new Error().stack, extraHeaders: __assign(__assign(__assign({}, (this.config.extraHeaders || {})), (this.config.environment
