...
export default class Site extends BaseResource {
    ...
    activateImprovedItemsListing() {
        return this.rawActivateImprovedItemsListing().then((body) => Utils.deserializeResponseBody(body));
    }
    /**
     * Activate improved items listing
     *
     ...
     * @deprecated This API call is to be considered private and might change without notice
     */
    rawActivateImprovedItemsListing() {
        return this.client.request({
            method: 'PUT',
    ...
    activateMillisecondsInDatetime() {
        return this.rawActivateMillisecondsInDatetime().then((body) => Utils.deserializeResponseBody(body));
    }
    /**
     * Activate milliseconds in datetime
     *
     ...
     * @deprecated This API call is to be considered private and might change without notice
     */
    rawActivateMillisecondsInDatetime() {
        return this.client.request({
            method: 'PUT',
