...
export function forEachNode(input, visitor, parent, path) {
    ...
    if (hasChildren(node)) {
        for (var index = 0; index < node.children.length; index++) {
            ...
            forEachNode(child, visitor, node, __spreadArrays(path, ['children', index]));
        }
    }
}
/**
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, forEachNodeAsync(child, visitor, node, __spreadArrays(path, ['children', index]))];
                case 3:
                    _a.sent();
                    _a.label = 4;
                case 4:
...
export function someNode(input, predicate, parent, path) {
    ...
    if (hasChildren(node)) {
        for (var index = 0; index < node.children.length; index++) {
            var child = node.children[index];
            if (someNode(child, predicate, node, __spreadArrays(path, ['children', index]))) {
                return true;
            }
        }
    }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    if (!(index < node.children.length)) return [3 /*break*/, 5];
                    child = node.children[index];
                    return [4 /*yield*/, someNodeAsync(child, predicate, node, __spreadArrays(path, ['children', index]))];
                case 3:
                    if (_a.sent()) {
                        return [2 /*return*/, true];
                    }
